...
Данная мини-прога может дистанционно управлять вашгим аккаунтом в VK.
Пока возможностей мало, но некоторые функции всё же работают.
Все модули уже встроенны в прогу, её нужно только запустить.

Прогал на vk_api. 
При частом использовании может заблочить вашу страницу за частые авторизации на сайте^^
